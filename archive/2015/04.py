...
n = 0
import hashlib
while not sol1.startswith("00000"):
    n += 1 
    sol1 = hashlib.md5(f"{input}{n}".encode('utf-8')).hexdigest()
sol1 = n
n = 0
while not sol2.startswith("000000"):
    n += 1 
    sol2 = hashlib.md5(f"{input}{n}".encode('utf-8')).hexdigest()
sol2 = n
